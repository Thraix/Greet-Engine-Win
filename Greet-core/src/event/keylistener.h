...
namespace greet { namespace event {
	...
	public:
		...
		virtual bool onPressed(const KeyPressedEvent& e) const = 0;// { LOG_INFO("KEYLISTENER", "here"); return false; };
		virtual bool onReleased(const KeyReleasedEvent& e)  const = 0;// { return false; };
	};
}}