...
namespace Greet
{
	...
	TextBox::TextBox(const Vec2& position, const Vec2& size, bool password)
		:GUI(position,size, LTRB(3,2,3,2)), m_password(password), m_font(FontManager::Get("anonymous", size.y-6)), m_cursorColor(ColorUtils::Vec3ToColorHex(ColorUtils::GetMaterialColor(120 / 360.0f, 9))),
